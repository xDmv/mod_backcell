  ...
  <div class="list-group" id="ocfilter-content">
      ...
      <?php } ?>
            ...
            <?php } ?>
	            ...
	            <?php } else { ?>
							<option value="" id="v-<?php echo $value['id']; ?>" disabled="disabled" style="display: none;"><?php echo $value['name']; ?></option>
							<?php } ?>
	            <?php } ?>
	          </select>
            ...
            <div class="collapse" id="ocfilter-hidden-values-<?php echo $option['option_id']; ?>">
                ...
                <input type="<?php echo $option['type']; ?>" name="ocfilter_filter[<?php echo $option['option_id']; ?>]" value="" disabled="disabled" style="display: none;" class="ocf-target" />
                <?php echo $value['name']; ?>
                <?php if ($show_counter) { ?>

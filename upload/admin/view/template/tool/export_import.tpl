				...
				<div class="tab-content">
					...
					<div class="tab-pane " id="tab-manufacture">
								...
								<div class="form-group">
									 ...
									 <button type="button" class=" btn btn-primary" id="etap1_prim" ><?php echo $button_prim; ?></button>
									 <button type="button" class=" btn btn-danger" id="etap1_del"  ><?php echo $button_del; ?></button>
								</div>
								<div class="form-group required" id="etap2">
									...
									<div class="col-sm-2" >
										<input type="number" id="procent"  class="form-control" value="0.00" min="-1000" max="1000" step="0.01"/>
									</div>
									<label class="col-sm-2"><?php echo $text_cheslo; ?></label>
									<div class="col-sm-2" >
										<input type="number" id="cheslo"  class="form-control" value="0.00" min="-1000" max="1000" step="0.01"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-12"><?php echo $text_etap3; ?></label>
									<div class="col-sm-2" >
										<button type="button" class="btn btn-primary" id="etap3_prim" ><?php echo $button_prim; ?></button>
									</div>
								</div>
